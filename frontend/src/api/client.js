...
export const parseMealManual = (profileId, items) => request('/meals/parse/manual', { method: 'POST', body: JSON.stringify({ profile_id: profileId, items }) })
...
export const getMealsRange = (profileId, startDate, endDate) => request(`/meals?${new URLSearchParams({ profile_id: profileId, start_date: startDate, end_date: endDate })}`)
